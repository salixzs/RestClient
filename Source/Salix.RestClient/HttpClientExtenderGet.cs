...
public abstract partial class HttpClientExtender
{
    ...
    /// <inheritdoc cref="IRestClient.GetAsync(string,dynamic?,QueryParameters?,object?,Dictionary{string,string}?)"/>
    ...
    /// <inheritdoc cref="IRestClient.GetAsync(string,dynamic,QueryParameters,object)"/>
    public virtual async Task<HttpResponseMessage> GetAsync(string operation, dynamic pathParameters,
    ...
    /// <inheritdoc cref="IRestClient.GetAsync(string,dynamic,QueryParameters)"/>
    public virtual async Task<HttpResponseMessage> GetAsync(string operation, dynamic pathParameters,
        QueryParameters queryParameters)
        => await this.GetAsync(operation: operation, pathParameters: pathParameters, queryParameters: queryParameters,
            data: null, headers: null).ConfigureAwait(false);

    /// <inheritdoc cref="IRestClient.GetAsync(string,dynamic,object)"/>
    ...
    /// <inheritdoc cref="IRestClient.GetAsync(string,dynamic)"/>
    public virtual async Task<HttpResponseMessage> GetAsync(string operation, dynamic pathParameters)
    ...
    /// <inheritdoc cref="IRestClient.GetAsync{T}(string,dynamic?,QueryParameters?,object?,Dictionary{string,string}?)"/>
    ...
    /// <inheritdoc cref="IRestClient.GetAsync{T}(string,dynamic,QueryParameters,object)"/>
    public virtual async Task<T> GetAsync<T>(string operation, dynamic pathParameters,
        QueryParameters queryParameters, object data)
    ...
    /// <inheritdoc cref="IRestClient.GetAsync{T}(string,dynamic,QueryParameters)"/>
    public virtual async Task<T> GetAsync<T>(string operation, dynamic pathParameters,
        QueryParameters queryParameters)
        => await this.GetAsync<T>(operation: operation, pathParameters: pathParameters,
    ...
    /// <inheritdoc cref="IRestClient.GetAsync{T}(string,dynamic,object)"/>
    ...
    /// <inheritdoc cref="IRestClient.GetAsync{T}(string,dynamic)"/>
    public virtual async Task<T> GetAsync<T>(string operation, dynamic pathParameters)
        => await this.GetAsync<T>(operation: operation, pathParameters: pathParameters, queryParameters: null,
            data: null, headers: null).ConfigureAwait(false);
