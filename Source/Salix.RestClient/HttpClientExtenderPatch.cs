...
public abstract partial class HttpClientExtender
{
    ...
    public virtual async Task<HttpResponseMessage> PatchAsync(string operation, object? data, PathParameters? pathParameters, QueryParameters? queryParameters, Dictionary<string, string>? headers)
    ...
    public virtual async Task<HttpResponseMessage> PatchAsync(string operation, object data, PathParameters pathParameters, QueryParameters queryParameters)
    ...
    public virtual async Task<HttpResponseMessage> PatchAsync(string operation, object data, QueryParameters queryParameters)
    ...
    /// <inheritdoc cref="IRestClient.PatchAsync(string,PathParameters,QueryParameters)"/>
    public virtual async Task<HttpResponseMessage> PatchAsync(string operation, PathParameters pathParameters, QueryParameters queryParameters)
        => await this.PatchAsync(operation: operation, data: null, pathParameters: pathParameters,
            queryParameters: queryParameters, headers: null).ConfigureAwait(false);

    /// <inheritdoc cref="IRestClient.PatchAsync(string,PathParameters)"/>
    public virtual async Task<HttpResponseMessage> PatchAsync(string operation, PathParameters pathParameters)
        => await this.PatchAsync(operation: operation, data: null, pathParameters: pathParameters,
            queryParameters: null, headers: null).ConfigureAwait(false);

    /// <inheritdoc cref="IRestClient.PatchAsync(string,QueryParameters)"/>
    public virtual async Task<HttpResponseMessage> PatchAsync(string operation, QueryParameters queryParameters)
    ...
    public virtual async Task<T?> PatchAsync<T>(string operation, object? data, PathParameters? pathParameters, QueryParameters? queryParameters, Dictionary<string, string>? headers)
    ...
    public virtual async Task<T?> PatchAsync<T>(string operation, object data, PathParameters pathParameters, QueryParameters queryParameters)
    ...
    /// <inheritdoc cref="IRestClient.PatchAsync{T}(string,PathParameters,QueryParameters)"/>
    public virtual async Task<T?> PatchAsync<T>(string operation, PathParameters pathParameters, QueryParameters queryParameters)
        => await this.PatchAsync<T>(operation: operation, data: null, pathParameters: pathParameters,
            queryParameters: queryParameters, headers: null).ConfigureAwait(false);

    /// <inheritdoc cref="IRestClient.PatchAsync{T}(string,PathParameters)"/>
    public virtual async Task<T?> PatchAsync<T>(string operation, PathParameters pathParameters)
        => await this.PatchAsync<T>(operation: operation, data: null, pathParameters: pathParameters,
            queryParameters: null, headers: null).ConfigureAwait(false);
