...
namespace RestClient.Tests
{
    ...
    public class TestClient : AbstractRestClient
    {
        ...
        public TestClient(HttpClient httpClient, RestServiceSettings parameters, ILogger logger)
            : base(httpClient, parameters, logger, NewtonsoftJsonObjectSerializer.Default)
        {
        }
